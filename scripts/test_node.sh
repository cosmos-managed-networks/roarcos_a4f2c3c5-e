...
#
# Examples:
# CHAIN_ID="local-1" HOME_DIR="~/.roarcos" BLOCK_TIME="1000ms" CLEAN=true sh scripts/test_node.sh
# CHAIN_ID="local-2" HOME_DIR="~/.roarcos" CLEAN=true RPC=36657 REST=2317 PROFF=6061 P2P=36656 GRPC=8090 GRPC_WEB=8091 ROSETTA=8081 BLOCK_TIME="500ms" sh scripts/test_node.sh
...
export HOME_DIR=$(eval echo "${HOME_DIR:-"~/.roarcos"}")
export BINARY=${BINARY:-roarcos}
export DENOM=${DENOM:-roarcos}
...
from_scratch () {
  ...
  # roarcos1efd63aw40lxf3n4mhf7dzhjkr453axur9yalha
  ...
  # roarcos1hj5fveer5cjtn4wd6wstzugjfdxzl0xpeswm75
